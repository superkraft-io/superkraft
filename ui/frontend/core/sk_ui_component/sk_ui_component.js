class sk_ui_component {
    ...
    initElement(withExistingElement){
        ...
        this.attributes.add({friendlyName: 'DAW plugin Param ID', name: 'dawPluginParamID', type: 'text', onSet: val => {
            if (!sk_api.dawPluginMngr) return console.error('[SK] Plugin manager not present. You are probably not running this app as a plugin.')

            sk_api.dawPluginMngr.add(val, this)
