class sk_ui_iceRink_v1 extends sk_ui_component {
    constructor(opt){
        super(opt)

        var msg = 'sk_ui_iceRink_v1 has been deprecated. Use sk_ui_iceRink instead'
        alert(msg)
        throw msg
        ...
        this.scrollbarX_wrapper = this.add.component(_c => {
            ...
            _c.animate = false
            _c.compact = true
            _c.classAdd('sk_ui_iceRink_v1_scrollbarWrapper sk_ui_iceRink_v1_scrollbarWrapper_x')

            this.scrollbarX_native = _c.add.component(_c => {
                _c.styling = 'top left'
                _c.classAdd('sk_ui_iceRink_v1_native_scrollbar sk_ui_iceRink_v1_native_scrollbar_x')
                _c.animate = false
                _c.fakeContent = _c.add.component(_c => {
                    _c.classAdd('sk_ui_iceRink_v1_native_scrollbar_fakeContent')
                    _c.animate = false
                })
        ...
        this.scrollbarY_wrapper = this.add.component(_c => {
            ...
            _c.animate = false
            _c.compact = true
            _c.classAdd('sk_ui_iceRink_v1_scrollbarWrapper sk_ui_iceRink_v1_scrollbarWrapper_y')

            this.scrollbarY_native = _c.add.component(_c => {
                _c.styling = 'top left'
                _c.classAdd('sk_ui_iceRink_v1_native_scrollbar sk_ui_iceRink_v1_native_scrollbar_y')
                _c.animate = false
                _c.fakeContent = _c.add.component(_c => {
                    _c.classAdd('sk_ui_iceRink_v1_native_scrollbar_fakeContent')
                    _c.animate = false
        ...
        this.contentWrapper = this.add.component(_c => {
            _c.classAdd('sk_ui_iceRink_v1_contentWrapper')
            ...
            this.content = _c.add.component(_c => {
                _c.classAdd('sk_ui_iceRink_v1_content')
...
class sk_ui_iceRink_v1_scrollbar extends sk_ui_component {
    constructor(opt){
        super(opt)
        ...
        this.handle = this.add.component(_c => {
            _c.classAdd('sk_ui_iceRink_v1_scrollbar_handle')
            _c.animate = false
        })
    ...
    set orientation(val){
        ...
        this.handle.classRemove('sk_ui_iceRink_v1_scrollbar_handle_x')
        this.handle.classRemove('sk_ui_iceRink_v1_scrollbar_handle_y')

        this.handle.classAdd('sk_ui_iceRink_v1_scrollbar_handle_' + (val === 'vertical' ? 'y' : 'x'))
    }
