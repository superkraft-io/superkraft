class sk_ui_1_vst_param_component_togglable extends sk_ui_component {
    constructor(opt) {
        super(opt)
    }
}

var sk_ui_vst_sk_ui_onAfterCreate = function(_c){
    sk_ui_vst_param_component_root.configRootHandlers(_c)
...
waitForSK().then(() => {
    document.addEventListener('sk_onAfterComponentCreated', _e => {
        ...
        if (_c instanceof sk_ui_checkbox || _c instanceof sk_ui_switch) {
            sk_ui_vst_sk_ui_onAfterCreate(_c)
        }
    })
})